...
public class stepDefination extends base {
	...
	public void subtract_two_numbers_and(String value1, String value2) throws Throwable {
		...
		System.out.println("Subtracting 6 - 3 ");

		Thread.sleep(1000);
		// clicking on 6
		int xOffsetsOfSix = 0;
		int yOffsetsOfSix = 100;
		new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset(xOffsetsOfSix, yOffsetsOfSix).click().build()
				.perform();
		Thread.sleep(1000);
	...
	public void divide_two_negative_numbers() throws Throwable {
		...
		// clicking on the subtract sign (-)
		int xOffsetsOfMinuss = 100;
		int yOffsetsOfMinuss = 250;
		new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset(xOffsetsOfMinuss, yOffsetsOfMinuss).click().build()
				.perform();
		Thread.sleep(1000);
	...
	public void divide_one_positive_by_one_negative_number() throws Throwable {
		...
		new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset(xOffsetsOfMinus2, yOffsetsOfMinus2).click().build()
				.perform();
		// clicking on 3
		int xOffsetsOfThreee = 0;
		int yOffsetsOfThreee = 250;
		new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset(xOffsetsOfThreee, yOffsetsOfThreee).click().build()
				.perform();
	...
	public void divide_number_by_zero() throws Throwable {
		...
		// clicking on the divide sign (/)
		int xOffsetsOfMinuss = 100;
		int yOffsetsOfMinuss = -100;
		new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset(xOffsetsOfMinuss, yOffsetsOfMinuss).click().build()
				.perform();
		Thread.sleep(1000);
		
		// clicking on 0
		int xOffsetsOfZero = 275;
		int yOffsetsOfZero = 420;
		new Actions(driver).moveToElement(canvas, 0, 0).moveByOffset(-xOffsetsOfZero, yOffsetsOfZero).click().build()
				.perform();
		Thread.sleep(1000);
